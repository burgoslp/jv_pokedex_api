...
INSERT INTO `types` (`id`,`name`,`description`) VALUES (NULL, 'Psíquico', 'Tipo de Pokemon que es fuerte contra Lucha y Veneno, y debil contra Acero, Psíquico y Siniestro.');
...
INSERT INTO `pokemons_weaknesses` (`pokemons_id`, `types_id`) VALUES (1, (SELECT id FROM types WHERE name = 'Agua'));
INSERT INTO `pokemons_weaknesses` (`pokemons_id`, `types_id`) VALUES (1, (SELECT id FROM types WHERE name = 'Planta'));
